...
__ALL__ = ["FTTransformerEmbedder", "FTTransformerTableEmbedder"]


class FTTransformerTableEmbedder(torch.nn.Module):
    def __init__(
        self,
        channels: int,
        out_channels: int,
...
class FTTransformerEmbedder(torch.nn.Module):
    def __init__(
        self,
        ...
        self.embedder = torch.nn.ModuleDict(
            {
                table_name: FTTransformerTableEmbedder(
                    channels=embed_dim,
