...
__ALL__ = ["TabNetEmbedder", "TabNetTableEmbedder"]


class TabNetTableEmbedder(torch.nn.Module):
    def __init__(
        self,
        channels: int,
        out_channels: int,
...
class TabNetEmbedder(torch.nn.Module):
    def __init__(
        self,
        ...
        self.embedder = torch.nn.ModuleDict(
            {
                table_name: TabNetTableEmbedder(
                    channels=embed_dim,
