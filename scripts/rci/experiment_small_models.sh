#!/bin/bash
#SBATCH --job-name=experiment-deep-db-small-models
...
python -u experiments/blueprint_mlflow.py --ray_address="local" --dataset=${dataset} \
    ...
    --seed=42 --num_samples=2 --model_type="honza" --num_cpus=${SLURM_CPUS_PER_TASK} &> "${log_dir}/honza.log"

python -u experiments/blueprint_mlflow.py --ray_address="local" --dataset=${dataset} \
    --experiment="pelesjak-deep-db-experiments-v3" --run_name=${id} --log_dir=${log_dir} \
    --seed=42 --num_samples=2 --model_type="transformer" --num_cpus=${SLURM_CPUS_PER_TASK} &> "${log_dir}/transformer.log"

python -u experiments/blueprint_mlflow.py --ray_address="local" --dataset=${dataset} \
    --experiment="pelesjak-deep-db-experiments-v3" --run_name=${id} --log_dir=${log_dir} \
    --seed=42 --num_samples=2 --model_type="tabnet" --num_cpus=${SLURM_CPUS_PER_TASK} &> "${log_dir}/tabnet.log"

python -u experiments/blueprint_mlflow.py --ray_address="local" --dataset=${dataset} \
    --experiment="pelesjak-deep-db-experiments-v3" --run_name=${id} --log_dir=${log_dir} \
    --seed=42 --num_samples=2 --model_type="trompt" --num_cpus=${SLURM_CPUS_PER_TASK} &> "${log_dir}/trompt.log"

python -u experiments/blueprint_mlflow.py --ray_address="local" --dataset=${dataset} \
    --experiment="pelesjak-deep-db-experiments-v3" --run_name=${id} --log_dir=${log_dir} \
    --seed=42 --num_samples=2 --model_type="tabtransformer" --num_cpus=${SLURM_CPUS_PER_TASK} &> "${log_dir}/tabtransformer.log"

python -u experiments/blueprint_mlflow.py --ray_address="local" --dataset=${dataset} \
    --experiment="pelesjak-deep-db-experiments-v3" --run_name=${id} --log_dir=${log_dir} \
    --seed=42 --num_samples=2 --model_type="saint" --num_cpus=${SLURM_CPUS_PER_TASK} &> "${log_dir}/saint.log"
